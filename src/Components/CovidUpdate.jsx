    ...
    <>
      ...
      <CustomModal show={show} handler={setShow} size="lg">
        ...
        <Row>
          ...
          <Col xs={12} md={8}>
            <p>We take the health and safety of our employees and clients very seriously. During this challenging time of the coronavirus crisis we have taken the proper steps to modify our business model to protect our employees and clients. We continue to remain open to best service our clients and we will continue to modify our business to follow the direction of the U.S. Centers for Disease Control and Prevention (CDC).</p>
